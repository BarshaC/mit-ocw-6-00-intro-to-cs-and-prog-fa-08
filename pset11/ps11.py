...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        self.cleanTiles[position] = self.cleanTiles.get(position,0) + 1
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        checkPosition = (int(m), int(n))
        if checkPosition in self.cleanTiles:
            return True
        else:
            return False
    ...
    def getRandomPosition(self):
        ...
        """
        randomPositionx = random.randint(0,self.width-1)
        randomPositiony = random.randint(0,self.height-1)
...
class BaseRobot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.position = getRobotPosition()
        self.room = room 
...
class Robot(BaseRobot):
    ...
    def updatePositionAndClean(self):
        ...
        while insideRoom == True:
            ...
            newPosition = currentPostion.getNewPosition(self.getRobotdirection,self.speed)
